...
Public Class rptFacturaReserva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptFacturaReserva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaReserva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaReserva = New rptFacturaReserva
        rpt.Site = Me.Site
        Return rpt
    End Function
