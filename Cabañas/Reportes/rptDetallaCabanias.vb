...
Public Class rptDetallaCabanias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptDetallaCabanias.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idCabanias() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptDetallaCabanias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetallaCabanias = New rptDetallaCabanias
        rpt.Site = Me.Site
        Return rpt
    End Function
