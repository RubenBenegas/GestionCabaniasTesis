...
Public Class rptFacturaAdicional
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFacturaAdicional.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptFacturaAdicional.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idReserva() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptFacturaAdicional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaAdicional = New rptFacturaAdicional
        rpt.Site = Me.Site
        Return rpt
    End Function
