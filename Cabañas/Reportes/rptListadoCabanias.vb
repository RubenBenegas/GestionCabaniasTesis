...
Public Class rptListadoCabanias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptListadoCabanias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoCabanias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoCabanias = New rptListadoCabanias
        rpt.Site = Me.Site
        Return rpt
    End Function
