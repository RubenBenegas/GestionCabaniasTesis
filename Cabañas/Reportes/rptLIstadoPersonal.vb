...
Public Class rptLIstadoPersonal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptLIstadoPersonal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLIstadoPersonal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLIstadoPersonal = New rptLIstadoPersonal
        rpt.Site = Me.Site
        Return rpt
    End Function
