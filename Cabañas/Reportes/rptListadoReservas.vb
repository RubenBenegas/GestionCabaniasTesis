...
Public Class rptListadoReservas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptListadoReservas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoReservas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoReservas = New rptListadoReservas
        rpt.Site = Me.Site
        Return rpt
    End Function
