...
Public Class rptListadoPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptListadoPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoPagos = New rptListadoPagos
        rpt.Site = Me.Site
        Return rpt
    End Function
