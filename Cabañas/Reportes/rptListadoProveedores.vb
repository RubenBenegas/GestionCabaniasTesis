...
Public Class rptListadoProveedores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptListadoProveedores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoProveedores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoProveedores = New rptListadoProveedores
        rpt.Site = Me.Site
        Return rpt
    End Function
