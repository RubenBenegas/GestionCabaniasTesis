...
Public Class rptDetalleHuesped
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptDetalleHuesped.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idHuesped() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptDetalleHuesped
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalleHuesped = New rptDetalleHuesped
        rpt.Site = Me.Site
        Return rpt
    End Function
