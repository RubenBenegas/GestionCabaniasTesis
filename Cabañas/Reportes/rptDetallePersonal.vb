...
Public Class rptDetallePersonal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptDetallePersonal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idPersonal() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptDetallePersonal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetallePersonal = New rptDetallePersonal
        rpt.Site = Me.Site
        Return rpt
    End Function
